...
async function transfer(originFederators, destinationFederators, config, origin, destination) {
    try {
        ...
        console.log('user tokens balance', (await originTokenContract.methods.balanceOf(userAddress).call()).toString())
        console.log('user tokens bridge alowance', (await originTokenContract.methods.allowance(userAddress, originBridgeAddress).call()).toString())
        ...
        console.log('allowTokensContract allowedTokens', (await allowTokensContract.methods.allowedTokens(originAddress).call()))
        console.log('allowTokensContract typeLimits', (await allowTokensContract.methods.typeLimits(0).call()))
