...
export const LOGGER_CATEGORY_TEST_FEDERATOR_NFT = 'NFT_FEDERATOR';
...
export const LOGGER_CATEGORY_FEDERATOR_NFT_MAIN = 'MAIN_NFT_FEDERATOR';
export const LOGGER_CATEGORY_FEDERATOR_NFT_SIDE = 'SIDE_NFT_FEDERATOR';
