...
module.exports = {
  ...
  networks: {
    ...
    goerli: {
      ...
      network_id: chains.GOERLI_TEST_NET_CHAIN_ID,
      token_symbol: 'e',
      gas: 6700000,
...
function getWrappedCurrencyAddressesByChainId() {
  ...
  wrappedCurrencyAddressesByChainId[chains.GOERLI_TEST_NET_CHAIN_ID] = '0x64D3251296DF05bD3Cb42D910b113F7EdAc08610';
...
function getProxyAdminAddressesByChainId() {
  ...
  proxyAdminAddressesByChainId[chains.GOERLI_TEST_NET_CHAIN_ID] = '0x39055c999A8528535Af012F4F4CF7B548dD97481';
...
function getAllowTokensProxyAddressesByChainId() {
  ...
  allowTokensProxyAddressesByChainId[chains.GOERLI_TEST_NET_CHAIN_ID] = '0x17d4c0dEBef2F28c3C04fFa953b0E18575f576ED';
...
function getBridgeProxyAddressesByChainId() {
  ...
  bridgeProxyAddressesByChainId[chains.GOERLI_TEST_NET_CHAIN_ID] = '0xa3aCF79Aded2DD5E2A8bd2E3D1E9f797E96972d3';
...
function getSideTokenFactoryAddressesByChainId() {
  ...
  sideTokenFactoryAddressesByChainId[chains.GOERLI_TEST_NET_CHAIN_ID] = '0x281B8cE947918058cf3341125Bba4dCCd07172FF';
