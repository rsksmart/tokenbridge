...
module.exports = class MMRNode {
    ...
    static fromBlock(block) {
        ...
        newNode.left = null;
        newNode.right = null;
        newNode.start_height = parseInt(block.number);
        newNode.end_height = parseInt(block.number);
    ...
    static fromValues(block) {
        ...
        newNode.left = null;
        newNode.right = null;
        newNode.start_height = parseInt(block.start_height);
        newNode.end_height = parseInt(block.end_height);
