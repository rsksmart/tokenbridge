...
const TOKENS = [ DOC_TOKEN, DAI_TOKEN, SAI_TOKEN, BITPRO_TOKEN, RIF_TOKEN, LINK_TOKEN, TUSD_TOKEN, USDT_TOKEN, USDC_TOKEN,
    WETH_TOKEN, ZRX_TOKEN, FLIXX_TOKEN, RFOX_TOKEN, OLD_TOKEN ];